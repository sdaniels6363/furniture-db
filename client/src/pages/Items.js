                ...
                <div className="dropdown">
                    ...
                    <div className="dropdown-menu" aria-labelledby="dropdownMenu2">
                        {this.state.vendors.map((vendor, i) => {
                            return (
                                <button className="dropdown-item" key={i} onClick={() => this.filterVendor(vendor)}>Show only {vendor}</button>
                            )
                        })}
                        <button className="dropdown-item" onClick={() => this.filterVendor("all")}>Show All</button>
                    </div>
                </div>
